...
if(BUILD_SHARED_LIBS)
  if(WIN32)
    set(CURSES_LIBRARIES ${CMAKE_INSTALL_FULL_BINDIR}/${CMAKE_SHARED_LIBRARY_PREFIX}pdcurses${CMAKE_SHARED_LIBRARY_SUFFIX})
  else()
    set(CURSES_LIBRARIES ${CMAKE_INSTALL_FULL_LIBDIR}/${CMAKE_SHARED_LIBRARY_PREFIX}pdcurses${CMAKE_SHARED_LIBRARY_SUFFIX})
  endif()

else()
  set(CURSES_LIBRARIES ${CMAKE_INSTALL_FULL_LIBDIR}/${CMAKE_STATIC_LIBRARY_PREFIX}pdcurses${CMAKE_STATIC_LIBRARY_SUFFIX})
endif()
